...
words["ade"]                         = { family: "L"        , short: "proposition"                  , long: "x1 is a proposition with predicate x2 among arguments x3 (set)", lojban: "bridi"};
words["ado"]                         = { family: "L"        , short: "proposition-tail"             , long: "x1 is a proposition-tail of proposition x2 with predicate x3 among arguments x4 (set)", lojban: "brirebla"};
words["asa"]                         = { family: "L"        , short: "name"                         , long: "x1 ([sa] predicate / quoted words) is a name of x2 given by x3", lojban: "cmene"};
words["ba"]                          = { family: "BA"       , short: "predication"                  , long: "x1 is predication [proposition] expressed in sentence x2", lojban: "du'u" };
words["bai"]                         = { family: "BAI"      , short: ""                             , long: "abstraction elidible terminator", lojban: "kei"};
words["ban"]                         = { family: "R"        , short: "language"                     , long: "x1 is a language/dialect used by x2 to express x3 (proposition)", lojban: "bangu" }
words["be"]                          = { family: "BA"       , short: "predicate"                    , long: "predicate expressed in [proposition] (allow predicate filling)", lojban: "BE filling but in NU"};
...
words["bo"]                          = { family: "BA"       , short: "property"                     , long: "x1 is the property exhibited by [proposition]", lojban: "nu"};
...
words["fue"]                         = { family: "FA"       , short: "restrictive adverbial"        , long: "restrictive adverbial. the first place of the provided predicate is claimed to occur in conjunction with the outer proposition ({mia fue mie} = {fa bi mia do fa'un je do mie})", lojban: "poi'a"};
words["fui"]                         = { family: "FA"       , short: "non-restrictive adverbial"    , long: "non-restrictive adverbial. the first place of the provided predicate is claimed to be such that the outer proposition satisfies it, and the outer proposition is claimed ({mia fui mie} = {fa bi mia bai va mua do fa'un de fa mua do mie})", lojban: "noi'a"};
words["fuo"]                         = { family: "FA"       , short: "subordinating adverbial"      , long: "subordinating adverbial. the outer proposition is claimed to satisfy the first place of the provided predicate, but is not itself claimed to occur ({mia fuo mie} = {fa bi mia do mie})", lojban: "soi'a"};
...
words["ma"]                          = { family: "MA"       , short: "?"                            , long: "predicate question, fill the blank", lojban: "ma / mo"};
words["mai"]                         = { family: "MA"       , short: "something #1"                 , long: "x1 is something that exists #1 (existential)", lojban: "da"};
words["mei"]                         = { family: "MA"       , short: "something #2"                 , long: "x1 is something that exists #2 (existential)", lojban: "de" };
...
words["moi"]                         = { family: "MA"       , short: "something #3"                 , long: "x1 is something that exists #3 (existential)", lojban: "di" };
...
words["sa"]                          = { family: "SA"       , short: "name"                         , long: "transform the predicate into a name : x1 is named <name> which is given by x2", lojban: "la"};
