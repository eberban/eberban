...
words["a.a"]                         = { family: "L"        , short: "lexeme"                       , signature: "OPS"        , long: "x1 is a lexeme meaning x2 (proposition) with components x3 (set)", lojban: "lujvo"};
...
words["ada"]                         = { family: "L"        , short: "paragraph"                    , signature: "OOS"        , long: "x1 is a paragraph about subject x2 composed of sentence(s) x3 (set)", lojban: "jufmei"};
words["ade"]                         = { family: "L"        , short: "proposition"                  , signature: "PPS"        , long: "x1 is a proposition with predicate x2 (abstraction) among arguments x3 (set)", lojban: "bridi"};
words["ado"]                         = { family: "L"        , short: "proposition-tail"             , signature: "PPPS"       , long: "x1 is a proposition-tail of proposition x2 with predicate x3 (abstraction) among arguments x4 (set)", lojban: "brirebla"};
words["asa"]                         = { family: "L"        , short: "name"                         , signature: "TOO"        , long: "x1 ([sa] predicate / quoted words) is a name of x2 given by x3", lojban: "cmene"};
words["ba"]                          = { family: "BA"       , short: "abstraction"                  , signature: "PT"         , long: "x1 is [proposition] expressed in sentence x2 (text)", lojban: "du'u" };
words["bai"]                         = { family: "BAI"      , short: ""                             ,                           long: "abstraction elidible terminator", lojban: "kei"};
words["ban"]                         = { family: "R"        , short: "language"                     , signature: "OOP"        , long: "x1 is a language/dialect used by x2 to express x3 (proposition)", lojban: "bangu" }
words["be"]                          = { family: "BA"       , short: "predicate"                    , signature: "P"          , long: "predicate expressed in [proposition] (allow predicate place filling)", lojban: "BE filling but in NU"};
words["ber"]                         = { family: "R"        , short: "eberbanic"                    , signature: "OQ"         , long: "x1 reflects eberbanic language/culture/nationality/community is aspect/property x2"};
words["bi"]                          = { family: "BA"       , short: "event"                        , signature: "E"          , long: "x1 is the event of [proposition]", lojban: "nu"};
words["bla"]                         = { family: "R"        , short: "future"                       , signature: "EE"         , long: "x1 (event) is in the future/after x2 (event)", lojban: "balvi" }
words["bo"]                          = { family: "BA"       , short: "property"                     , signature: "Q"          , long: "x1 is the property exhibited by [proposition]", lojban: "nu"};
words["bria"]                        = { family: "R"        , short: "arm"                          , signature: "OO"         , long: "x1 is a/the arm of x2", lojban: "cabna" }
words["by"]                          = { family: "BY"       , short: "B"                                                      , long: "letter B", lojban: "by"};
words["ca"]                          = { family: "CA"       , short: "or"                                                     , long: "predicate connective or", lojban: "ja"};
words["cai"]                         = { family: "CAI"      , short: "(addressing)"                                           , long: "call someone's attention", lojban: "doi"};
words["ce"]                          = { family: "CA"       , short: "and"                                                    , long: "predicate connective and", lojban: "je"};
...
words["cki'a"]                       = { family: "R"        , short: "write"                        , signature: "OTOO"       , long: "x1 inscribes/writes x2 on display/surface/storage medium x3 with writing implement x4", lojban: "ciska"};
words["cku'a"]                       = { family: "R"        , short: "book"                         , signature: "OOOOO"      , long: "x1 is a book containing work x2 by author x3 for audience x4 preserved in medium x5", lojban: "cukta"};
...
words["co"]                          = { family: "CA"       , short: "iif"                                                    , long: "predicate connective if-and-only-if", lojban: "jo"};
words["coi"]                         = { family: "CAI"      , short: "(hello)"                                                , long: "greetings/hello", lojban: "coi"};
words["cti'a"]                       = { family: "R"        , short: "eat"                          , signature: "OO"         , long: "x1 eats x2", lojban: "citka" }
words["cu"]                          = { family: "CA"       , short: "whether-or-not"                                         , long: "predicate connective whether-or-not", lojban: "ju"};
words["cy"]                          = { family: "BY"       , short: "C"                                                      , long: "letter C", lojban: "cy"};
words["da'ul"]                       = { family: "R"        , short: "animal"                       , signature: "OO"         , long: "x1 is an animal/creature of species x2", lojban: "danlu"};
...
words["dje"]                         = { family: "R"        , short: "day"                          , signature: "ONO"        , long: "x1 is x2 full days in duration (default = 1) by standard x3", lojban: "djedi" }
words["dju"]                         = { family: "R"        , short: "know"                         , signature: "OPOO"       , long: "x1 knows fact(s) x2 (abstraction) about subject x3 by epistemology x4", lojban: "djuno" }
...
words["dra'u"]                       = { family: "R"        , short: "milk"                         , signature: "OO"         , long: "x1 is milk from source x2", lojban: "ladru" }
words["du'an"]                       = { family: "R"        , short: "give"                         , signature: "OOO"        , long: "x1 (donor) gives/donates gift/present x2 to recipient x3 (without payment/exchange)", lojban: "dunda"};
...
words["dza'u"]                       = { family: "R"        , short: "walk"                         , signature: "OOO"        , long: "x1 walks/strides/paces on surface x2 using limbs x3", lojban: "cadzu"};
...
words["eberban"]                     = { family: "L"        , short: "eberban"                      , signature: "OOP"        , long: "x1 is the eberban language used by x2 to express/communicate x3 (abstraction)"};
words["eberpre"]                     = { family: "L"        , short: "eberbanist"                   , signature: "OQ"         , long: "x1 is an eberban speaker in aspect/property x2"};
words["ekanmer"]                     = { family: "L"        , short: "man"                          , signature: "O"          , long: "x1 is a man/men", lojban: "nanmu"};
...
words["fin"]                         = { family: "R"        , short: "create"                       , signature: "OOPO"       , long: "x1 invents/creates/composes/authors x2 for function/purpose x3 (proposition) from existing elements/ideas x4", lojban: "finti"};
words["fo"]                          = { family: "FA"       , short: "x4"                                                     , long: "tag proposition place #4", lojban: "fo" };
words["foi"]                         = { family: "FA"       , short: "prenex"                                                 , long: "don't not fill a place. can be used to provide a topic or declare existencial predicates", lojban: "fai'i" };
...
words["gle'i"]                       = { family: "R"        , short: "happy"                        , signature: "OE"         , long: "x1 is happy about x2 (event/state)", lojban: "gleki"};
...
words["gre'u"]                       = { family: "R"        , short: "dog"                          , signature: "OO"         , long: "x1 is a dog (canine) of specie/breed x2", lojban: "gerku"};
...
words["jgai"]                        = { family: "R"        , short: "hold"                         , signature: "OOOO"       , long: "x1 graps/holds x2 with x3 (part of x1) at locus x4 (part of x2)", lojban: "jgari"};
...
words["ka'en"]                       = { family: "R"        , short: "able"                         , signature: "OOO"        , long: "x1 is able to do/be/capable of doing/being x2 (event/state) under conditions (event/state)", lojban: "kakne"};
...
words["kan"]                         = { family: "R"        , short: "male"                         , signature: "O"          , long: "x1 is male", lojban: "nakni"};
words["ky"]                          = { family: "BY"       , short: "K"                                                      , long: "letter K", lojban: "ky"};
words["ma'i"]                        = { family: "MA"       , short: "this"                         , signature: "O"          , long: "x1 is this here near speaker", lojban: "ti"};
words["ma'o"]                        = { family: "MA"       , short: "that"                         , signature: "O"          , long: "x1 is that here near listener", lojban: "ta" };
words["ma'u"]                        = { family: "MA"       , short: "that younder"                 , signature: "O"          , long: "x1 is that younder, far from speaker and listener", lojban: "tu" };
words["ma"]                          = { family: "MA"       , short: "?"                            , signature: "?"          , long: "predicate question, fill the blank", lojban: "ma / mo"};
words["mai"]                         = { family: "MA"       , short: "something #1"                 , signature: "?"          , long: "x1 is something that exists #1 (existential)", lojban: "da"};
words["mei"]                         = { family: "MA"       , short: "something #2"                 , signature: "?"          , long: "x1 is something that exists #2 (existential)", lojban: "de" };
words["mer"]                         = { family: "R"        , short: "human"                        , signature: "O"          , long: "x1 is human", lojban: "remna"};
words["mi'i"]                        = { family: "MA"       , short: "me & others"                  , signature: "O"          , long: "x1 is me/we/the the speaker(s)/authors(s) & others but no you the listener(s)", lojban: "mi'a" };
words["mi'o"]                        = { family: "MA"       , short: "me & you"                     , signature: "O"          , long: "x1 is me/we/the the speaker(s)/authors(s) & you the listener(s)", lojban: "mi'o" };
words["mi'oi"]                       = { family: "MA"       , short: "me & you & others"            , signature: "O"          , long: "x1 is me/we/the speaker(s)/authors(s) & you the listener(s) & others", lojban: "ma'a" };
words["mi"]                          = { family: "MA"       , short: "me"                           , signature: "O"          , long: "x1 is me/we/the speaker(s)/authors(s)", lojban: "mi" };
words["mia'a"]                       = { family: "MA"       , short: "var I-6"                      , signature: "?"          , long: "affectable/contextual variable I-6", lojban: "fo'a" };
words["mia'e"]                       = { family: "MA"       , short: "var I-7"                      , signature: "?"          , long: "affectable/contextual variable I-7", lojban: "fo'e" };
words["mia'i"]                       = { family: "MA"       , short: "var I-8"                      , signature: "?"          , long: "affectable/contextual variable I-8", lojban: "fo'i" };
words["mia'o"]                       = { family: "MA"       , short: "var I-9"                      , signature: "?"          , long: "affectable/contextual variable I-9", lojban: "fo'o" };
words["mia'u"]                       = { family: "MA"       , short: "var I-10"                     , signature: "?"          , long: "affectable/contextual variable I-10", lojban: "fo'u" };
words["mia"]                         = { family: "MA"       , short: "var I-1"                      , signature: "?"          , long: "affectable/contextual variable I-1", lojban: "ko'a" };
words["mie"]                         = { family: "MA"       , short: "var I-2"                      , signature: "?"          , long: "affectable/contextual variable I-2", lojban: "ko'e" };
words["mii"]                         = { family: "MA"       , short: "var I-3"                      , signature: "?"          , long: "affectable/contextual variable I-3", lojban: "ko'i" };
words["mio"]                         = { family: "MA"       , short: "var I-4"                      , signature: "?"          , long: "affectable/contextual variable I-4", lojban: "ko'o" };
words["miu"]                         = { family: "MA"       , short: "var I-5"                      , signature: "?"          , long: "affectable/contextual variable I-5", lojban: "ko'u" };
words["mla'u"]                       = { family: "R"        , short: "cat"                          , signature: "OO"         , long: "x1 is a feline animal of specie/breed x2", lojban: "mlatu"};
words["mo'a"]                        = { family: "MA"       , short: "you!"                         , signature: "O"          , long: "x1 is you (imperative), make it true for you, the listener", lojban: "ko"};
words["mo'i"]                        = { family: "MA"       , short: "you & others"                 , signature: "O"          , long: "x1 is you listener(s) & others", lojban: "do'o"};
words["mo"]                          = { family: "MA"       , short: "you"                          , signature: "O"          , long: "x1 is you listener(s)", lojban: "do"};
words["moi"]                         = { family: "MA"       , short: "something #3"                 , signature: "?"          , long: "x1 is something that exists #3 (existential)", lojban: "di" };
words["mu"]                          = { family: "MA"       , short: "(elliptical)"                 , signature: "?"          , long: "elliptical/unspecified predicate" };
words["mu'e"]                        = { family: "MA"       , short: "(object of relative clause)"  , signature: "?"          , long: "binds to the relativized object of a relative clause" };
words["mu'o"]                        = { family: "MA"       , short: "(open space binding)"         , signature: "?"          , long: "binds a variable within an abstraction that represents an open space (such as <bo> properties)" };
words["mu'a"]                        = { family: "MA"       , short: "(previous value)"             , signature: "?"          , long: "when the content of a place is overritten, it represents the previous content of the place" };
words["mua"]                         = { family: "MA"       , short: "var U-1"                      , signature: "?"          , long: "affectable/contextual variable U-1", lojban: "broda" };
words["mue"]                         = { family: "MA"       , short: "var U-2"                      , signature: "?"          , long: "affectable/contextual variable U-2", lojban: "brode" };
words["mui"]                         = { family: "MA"       , short: "var U-3"                      , signature: "?"          , long: "affectable/contextual variable U-3", lojban: "brodi" };
words["muo"]                         = { family: "MA"       , short: "var U-4"                      , signature: "?"          , long: "affectable/contextual variable U-4", lojban: "brodo" };
words["muu"]                         = { family: "MA"       , short: "var U-5"                      , signature: "?"          , long: "affectable/contextual variable U-5", lojban: "brodu" };
...
words["pa'an"]                       = { family: "R"        , short: "hope"                         , signature: "OEN"        , long: "x1 hopes/wishes for/desires x2 (event) with expected likelihood x3 (between 0 and 1)", lojban: "pacna"};
...
words["pe'on"]                       = { family: "R"        , short: "friend"                       , signature: "OO"         , long: "x1 is a friend of x2", lojban: "pendo"};
words["pi"]                          = { family: "PE"       , short: ""                                                       , long: "discursive starter", lojban: "sei"};
words["pin"]                         = { family: "R"        , short: "drink"                        , signature: "OOO"        , long: "x1 drinks liquid x2 out of container x3", lojban: "pinxe"};
words["pli"]                         = { family: "R"        , short: "tool"                         , signature: "OOP"        , long: "x1 is a tool used by x2 for purpose x3 (predicate)", lojban: "swapped pilno"};
words["plie"]                        = { family: "R"        , short: "apple"                        , signature: "OO"         , long: "x1 is an apple of species/strain x2", lojban: "plise"};
...
words["pre"]                         = { family: "R"        , short: "person"                       , signature: "O"          , long: "x1 is a person", lojban: "prenu"};
words["prei"]                        = { family: "R"        , short: "parent"                       , signature: "OO"         , long: "x1 is a parent of/raises x2", lojban: "rirni/preri"};
...
words["sku"]                         = { family: "R"        , short: "express"                      , signature: "OTOO"       , long: "x1 (agent) express x2 (text) for audience x3 via medium x4", lojban: "cusku"};
words["so"]                          = { family: "SA"       , short: "x1 &#8652; x4"                                          , long: "switch 1st and 4th places", lojban: "ve" };
words["soi"]                         = { family: "SA"       , short: "referent of"                  , signature: "?"          , long: "the referent of (indirect pointer)", lojban: "la'e" };
...
words["vla"]                         = { family: "R"        , short: "talk"                         , signature: "OOOOO"      , long: "x1 communicate with x2 about subject x3 via medium x4 in language x5", lojban: "modified tavla"};
...
words["za"]                          = { family: "ZA"       , short: "(simple)"                     , signature: "O"          , long: "prefix a foreign word, meaning 'x1 is a [word]'", lojban: "cmevla/fu'ivla"};
words["zai"]                         = { family: "ZA"       , short: "(complex)"                                              , long: "prefix a foreign word, place structure is infered from context", lojban: "fu'ivla"};
words["zda'i"]                       = { family: "R"        , short: "home"                         , signature: "OO"         , long: "x1 is a nest/house/home of x2", lojban: "zdani"};
words["zdi'e"]                       = { family: "R"        , short: "amusing"                      , signature: "OOQ"        , long: "x1 is amusing to x2 in property/aspect x3", lojban: "zdile"};
words["zdu"]                         = { family: "R"        , short: "do"                           , signature: "OEP"        , long: "x1 is a volitional entity employings/taking action/doing x2 (event) for purpose x3 (proposition)", lojban: "zukte"};
words["ze"]                          = { family: "ZE"       , short: "&#12317;"                     , signature: "Q"          , long: "start grammatical quote", lojban: "lu"};
words["zei"]                         = { family: "ZEI"      , short: "&#12318;"                                               , long: "end grammatical quote", lojban: "li'u"};
words["zi"]                          = { family: "ZI"       , short: "&#34;"                        , signature: "Q"          , long: "quote the following word", lojban: "zo"};
words["zo"]                          = { family: "ZO"       , short: "&#12317;"                     , signature: "Q"          , long: "start ungrammatical quote", lojban: "lo'u"};
words["zoi"]                         = { family: "ZOI"      , short: "&#12318;"                                               , long: "end ungrammatical quote", lojban: "le'u"};
words["zu"]                          = { family: "ZU"       , short: ""                             , signature: "Q"          , long: "prefix a foreign word quote surrounded by the same 1 native word", lojban: "zoi"};
words["zva"]                         = { family: "R"        , short: "attending"                    , signature: "PE"         , long: "x1 is at/attenting/present at x2 (event/location)", lojban: "zvati"};
