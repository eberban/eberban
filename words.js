...
words["ca"]                          = { family: "CA"       , short: "or"                                                     , long: "___ (property/event/proposition) is satisfied/claimed/claimed to happend if [left] OR [right] are", lojban: "ja"};
words["cai"]                         = { family: "CAI"      , short: "(addressing)"                                           , long: "call someone's attention", lojban: "doi"};
words["ce"]                          = { family: "CA"       , short: "and"                                                    , long: "___ (property/event/proposition) is satisfied/claimed/claimed to happend if [left] AND [right] are", lojban: "je"};
...
words["co"]                          = { family: "CA"       , short: "iif"                                                    , long: "___ (property/event/proposition) is satisfied/claimed/claimed to happend if both [left] and [right] are, or both are not", lojban: "jo"};
...
words["cu"]                          = { family: "CA"       , short: "whether-or-not"                                         , long: "___ (property/event/proposition) is satisfied/claimed/claimed to happend if both [left] is (regardless of the right)", lojban: "ju"};
