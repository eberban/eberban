...
sentence_ni = expr:(NI_clause unit_definable) {return _node("sentence_ni", expr);}
...
chain_unit_2 = expr:(BA_clause / MI_clause / unit_quote / unit_scoped / unit_borrowing / unit_number / unit_definable / unit_inline_assignement) {return _node("chain_unit_2", expr);}
unit_inline_assignement = expr:(free_prefix* BO_clause? (KI_clause / unit_definable_2)) {return _node("unit_inline_assignement", expr);}

unit_definable = expr:(unit_definable_namespaced / unit_definable_2) {return _node("unit_definable", expr);}
unit_definable_namespaced = expr:((unit_definable_2 PI_clause)+ unit_definable_2) {return _node("unit_definable_namespaced", expr);}
...
TI = expr:(&particle_word (t vhowels / digit) &post_word) {return _node("TI", expr);}
...
compound_2 = expr:(e !(n / r) i? compound_word compound_word) {return _node("compound_2", expr);}
compound_3 = expr:(e n i? compound_word compound_word compound_word) {return _node("compound_3", expr);}
compound_n = expr:(e r i? (!compound_n_end compound_word)+ compound_n_end) {return _node("compound_n", expr);}
...
freeform_consonants = expr:(consonant_triplet / medial_pair / hyphen (initial_pair / consonant)) {return _node("freeform_consonants", expr);}
