...
list = expr:(compact_list / (list_item BU_clause !BU_clause)+ list_item?) {return _node("list", expr);}
list_item = expr:(chain) {return _node("list_item", expr);}
compact_list = expr:(BU_clause BU_clause compact_list_item+ !BU_clause) {return _node("compact_list", expr);}
compact_list_item = expr:(BI_clause? chain_step) {return _node("compact_list_item", expr);}
...
// - Spaces / Pause
pause_start = expr:(vowel / sonorant / h) {return _node("pause_start", expr);}
