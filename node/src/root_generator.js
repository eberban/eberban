...
const generators = {
	...
	C: () => pick_random([ generate_CVCV(1, 2), generate_CVCV(2, 1), generate_CCVCV(1, 1) ]),
	D: () =>
		pick_random([
			// bias towards CVCCV :p
			generate_CVCCV(1, 1),
	...
	Bn: () => pick_random([ generate_CCVCV(1, 0), generate_CVCV(2, 0) ]),
	Cn: () => pick_random([ generate_CVCV(3, 0), generate_CCVCV(2, 0) ]),
};
