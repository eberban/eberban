...
- **Triplets** (max 3 consonants in row):
  - Medial+Initial: medial pair + initial pair, e.g. `pks`, `ktc`, `bgz`
  - Onset+Liquid: (medial or initial pair, Y not m nor sonorant) + liquid r/l, e.g. `pkl`, `ptr`, `spl`, `str`
