...
words["vi"]                          = { family: "FA"       , short: "restrictive"                  , long: "restrictive adverbial. the first place of the provided relation is claimed to occur in conjunction with the outer predicate", lojban: "poi'a"};
...
words["vo"]                          = { family: "FA"       , short: "non-restrictive"              , long: "non-restrictive adverbial. the first place of the provided relation is claimed to be such that the outer predicate satisfies it, and the outer predicate is claimed", lojban: "noi'a"};
words["vu"]                          = { family: "FA"       , short: "subordinating"                , long: "subordinating adverbial. the outer predicate is claimed to satisfy the first place of the provided relation, but is not itself claimed to occur", lojban: "soi'a"};
